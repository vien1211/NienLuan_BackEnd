...
const createProduct = (newProduct) => {
    return new Promise(async (resolve, reject) => {
        const { name, image, type, brand, countInStock, price, rating, description } = newProduct
        try {
...
const getSoldQuantity = async (productId) => {
    try {
        ...
        return product.selled;
    } catch (error) {
        throw new Error(`Failed to get sold quantity: ${error.message}`);
    }
};
